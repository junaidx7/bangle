  ...
  app: {
    ...
    dialogs: {
      ...
      createView: {
        ...
        andLabel: 'UND',
        orLabel: 'ODER',
        matchAll: 'Alle Bedingungen erfullen',
        matchAny: 'Eine Bedingung erfullen',
        addFilter: 'Filter hinzufugen',
        addGroup: 'Gruppe hinzufugen',
        removeFilter: 'Filter entfernen',
        removeGroup: 'Gruppe entfernen',
        fieldPlaceholder: 'Feld',
        valuePlaceholder: 'Wert',
        operatorLabel: 'Bedingung',
        regexLabel: 'Als regularen Ausdruck behandeln',
        nameRequired: 'Gib der Ansicht einen Namen.',
        incompleteFilter: 'Jeder Filter braucht ein Feld und einen Wert.',
      },
      createWorkspace: {
